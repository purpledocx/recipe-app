...
<p align="center">
  Built with a classic Model-View-Controller (MVC) architecture, featuring server-rendered views and sample data seeding for seamless local development.
</p>
...
| **Architecture** | MVC Pattern (`controllers/`, `models/`, `routes/`, `views/`) |
